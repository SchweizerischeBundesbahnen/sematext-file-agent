...
fileLogger.prototype.log = function (level, message, fields, callback) {
    ...
    // Own log line
    var logRowFormatted = `INDEX: ${_index} | TIMESTAMP: ${msg["@timestamp"].toISOString()} | POD_NAME: ${msg.kubernetes.pod_name} | NAMESPACE: ${msg.kubernetes.namespace} | HOST: ${msg.host} | SEVERITY: ${msg.severity} | MESSAGE: ${msg.message}`;
