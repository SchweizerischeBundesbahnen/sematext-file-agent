...
fileLogger.prototype.log = function (level, message, fields, callback) {
    ...
    console.log(msg.kubernetes, msg.kubernetes.name_container);

    // Own log line
    var logRowFormatted = `INDEX: ${_index} | TIMESTAMP: ${msg["@timestamp"].toISOString()} | HOST: ${msg.host} | MESSAGE: ${msg.message} | POD_NAME: ${msg.kubernetes.pod_name} | NAMESPACE: ${msg.kubernetes.namespace} | NAMECONTAIER: ${msg.kubernetes.name_container} | SEVERITY: ${msg.severity}`;
