...
var logPath = process.env.LOGFILE_PATH || '/logs/fluent-containers.';
var rotateMb = parseInt(process.env.ROTATE_MB) || 50;
var rotateMaxFiles = parseInt(process.env.ROTATE_MAX_FILES) || 10;
...
function fileLogger(token) {
    ...
    events.EventEmitter.setMaxListeners(0);
...
fileLogger.prototype.log = function (level, message, fields, callback) {
    ...
    // Own log line
    var logRowFormatted = `INDEX: ${_index} | TIMESTAMP: ${msg["@timestamp"]} | POD_NAME: ${msg.kubernetes.pod_name} | NAMESPACE: ${msg.kubernetes.namespace} | HOST: ${msg.host} | SEVERITY: ${msg.severity} | MESSAGE: ${msg.message}`;
