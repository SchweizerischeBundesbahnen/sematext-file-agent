...
function fileLogger(token, podName) {
    ...
    console.log('new logger for', token, podName)
...
fileLogger.prototype.log = function (level, message, fields, callback) {
    ...
    let logRowFormatted = `INDEX: ${_index} | TIMESTAMP: ${msg["@timestamp"].toISOString()} | HOST: ${msg.host} | MESSAGE: ${msg.message} | POD_NAME: ${msg.kubernetes.pod_name} | NAMESPACE: ${msg.kubernetes.namespace} | NAMECONTAIER: ${msg.kubernetes.container_name} | SEVERITY: ${msg.severity}`;
